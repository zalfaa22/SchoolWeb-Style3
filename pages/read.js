  ...
  return (
    ...
    >
      ...
      <div class="col-xl-12 row justify-content-center d-flex">
        ...
        <p class="title   fw-bold  col-xl-12 m-0 px-3 py-2">
          Gotong Royong di Sekolah, Bantu Anak Segera Kembali ke Sekolah
        </p>
        <p class="text text-start   fw-normal  col-xl-12 m-0 px-3 py-2">
          Penulis : Shinta A.P
        </p>
        <p class="text par text-justify    fw-normal  col-xl-12 m-0 px-3 py-2">
