  ...
  return (
    <>
      ...
      >
            ...
            <div className="col-md-4 col-12">
              <div className="card mb-4 mb-lg-0 rounded-3">
                <div className="card-body p-4">
                  ...
                  <h3 className="mb-3 text-dark fs-5 fw-semibold text-center">
                    Kurikulum Terbaru
                  </h3>
                  <p className="mb-0 text-center text-dark fs-6 fw-normal px-2">
            ...
            <div className="col-md-4 col-12">
              <div className="card mb-4 mb-lg-0 rounded-3">
                <div className="card-body p-4">
                  ...
                  <p className="mb-0 text-center text-dark fs-6 fw-normal">
        ...
        <div className="container d-md-flex align-items-center text-center py-10">
          <img
            className="rafiki1  py-5  mb-4 mb-md-0 "
            src="keunggulan1.svg"
            alt=""
          />
  ...
  return (
    <>
      ...
      >
        ...
        <div className="container d-md-flex align-items-center py-10 text-center">
          <img
            className="rafiki2  py-5  mb-4 mb-md-0 "
            src="keunggulan2.svg"
            alt=""
          />
