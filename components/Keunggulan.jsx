...
function Keunggulan1() {
  return (
    <>
      ...
      >
        <div className="text-center fs-3 text-white fw-bold pt-4">
            ...
            <div class="col-md-4 col-12">
              ...
              <div class="card mb-4 mb-lg-0">
                ...
                <div class="card-body p-4">
                  ...
                  <h3 class="mb-3 fs-5 fw-bolder text-center">
                    Kurikulum Terbaru
                  </h3>
                  <p class="mb-0 text-center px-2">
                    Menerapkan kurikulum terbaru agar siswa mendapatakan materi
                    terbaru
                  </p>
                </div>
              </div>
        ...
        <div class="container d-md-flex align-items-center py-10">
          <img
            class=" w-100 py-5  mb-4 mb-md-0 "
            src="keunggulan1.svg"
            alt=""
          />
          <div class="fw-bold text-white ms-5 fs-3 text-start px-lg-5 mx-auto me-lg-5">
            Tentang kami
        ...
        <div class="container d-md-flex align-items-center py-10">
          ...
          <div class="fw-bold text-white ms-5 fs-3 text-start px-lg-5 mx-auto me-lg-5">
            ...
            <div class="fw-normal fs-6 pt-4 ">
              ...
              fokus mengembangkan minat tersebut. Sekolah ini didirikan sejak
              tahun 1989 dan terus berkembang hingga saat ini. Sejak berdirinya
              sekolah ini, sudah lebih dari 250.000 siswa lulus dari sekolah
              kami. Dengan menjunjung tinggi kejujuran, kedisiplinan dan
              semangat belajar yang tinggi kami berharap bisa terus meghasilkan
              siswa-siswa lulusan terbaik dari sekolah ini.
            </div>
          </div>
        </div>
      </div>
...
export { Keunggulan1, Keunggulan2 };
